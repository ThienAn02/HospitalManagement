...
ARG DB_HOST=jdbc:postgresql://postgres:5432/hospital_manage_dev
ARG DB_NAME=hospital_manage_dev
...
COPY --from=builder /app/target/hospitalManagement.war $JBOSS_HOME/standalone/deployments/
